...
function loadEducations(educations){
	...
	for(i=0;i<educations.length;i++){
		education = '<div class="row education"><div class="col m6 s12">					<div class="row title">'+educations[i].course+'<hr></div><div class="row">'+educations[i].periodStart+'-'+educations[i].periodEnd+'</div><div class="row">'+educations[i].inst+'</div>		<div class="row">Scored: '+educations[i].score+'</div>  <div class="row">Ranking: '+educations[i].ranking+'</div> </div><div class="col m6 s12 details"><ul class="collapsible" data-collapsible="accordion"><li><div class="collapsible-header"><i class="material-icons">view_list</i>Completed following Core courses</div><div class="collapsible-body">';
...
var profile;
	swal(
		{
			title:"helloWorld!!!",
			text:"Hello visitor, you have landed upon little webspace of YanRu-Jhou.",
